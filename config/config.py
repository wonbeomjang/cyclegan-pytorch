...
parser.add_argument('--image_size', type=int, default=340, help='the height / width of the input image to network')
...
parser.add_argument('--lambda_identity', type=float, default=30.0, help='number of data loading workers')
