...
parser.add_argument('--decay_epoch_1', type=int, default=10, help='adam: learning rate decay start epoch num')
parser.add_argument('--decay_epoch_2', type=int, default=10, help='adam: learning rate decay start epoch num')
parser.add_argument('--decay_epoch', type=int, default=10, help='learning rate decay start epoch num')
parser.add_argument('--num_epoch', type=int, default=10, help='learning rate decay start epoch num')
...
parser.add_argument('--lambda_cycle', type=int, default=0.5, help='number of data loading workers')
parser.add_argument('--lambda_identity', type=int, default=0.5, help='number of data loading workers')
