...
urls = {'monet2photo': 'https://people.eecs.berkeley.edu/~taesung_park/CycleGAN/datasets/monet2photo.zip',
...
download_url(urls[args.style], os.path.join('temp', f'{args.style}.zip'))
